...
ActiveRecord::Base.transaction do
  ...
  STAND_DATA = {
    ...
    "ガパオや" => [:ethnic],
    "京都 櫻川" => [:noodle, :washoku],
    "ルクソールカバブ（エジプト料理）" => [],
    "JASMINE THAI" => [:ethnic, :curry],
    "麺屋「極」" => [:noodle],
    "博多一風堂" => [:noodle],
    "渡なべ" => [:noodle],
    "Bassic." => [],
    ...
    "森のハイジカレー" => [:curry],
    "石見食堂" => [:ethnic],
    "三茶.KUNIKAGE" => [:noodle, :washoku],
    "ミートバル仙台本店(ビストロ・ヤマライ)" => [:niku],
    "みつばちカフェhonobono号" => [],
    "タナカクマキチ。" => [:noodle, :vege],
    "朝霧食堂" => [:niku],
    "The Atomic cafe" => [:niku, :beer],
    "太陽食堂 空いろ" => [],
    "天然酵母パン ルヴァン" => [],
    "東山食堂" => [],
    "SWNKA SHANKA" => [],
    "下町バル ながおか屋" => [:niku],
    "井の頭 ナムチャイ" => [:ethnic, :noodle],
    "PRIMAL" => [],
    "SAKURAGUMI" => [:piza],
    "新潟あさごはん" => [:washoku],
    "ラテン料理y" => [],
    "タイ国料理ジャイタイ" => [:ethnic, :noodle],
    "老舗肉問屋 小川畜産" => [:niku],
